...
%%%
%%% OUTPUTS:
%%%     IS2 = icesat2 csv with snow cover and reference snow cover map dates
%%%     appened for each ICESat-2 segment
%%%
...
for i = 1:size(IS2datenum_unique,1) %8
    ...
    figure; im = imagesc([snowX./(10^3)],[snowY./(10^3)],snowcover); colormap gray; hold on; 
    set(gca,'clim',[0 1]);
