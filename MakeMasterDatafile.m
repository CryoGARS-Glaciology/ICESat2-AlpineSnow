...
%%%
%%% SPECIFIED INPUTS:
%%%     folderpath = path to Sites folder 
%%%     abbrev = site abriviation for file name
%%%     Grouping = type of coregistration performed
%%%
%%% REQUIRED FILES:
%%%     ICESat-2 file (output from batch_icesat2_terrain_parameter_comparison.m)
%%%     reference elevations file (output from DTM_reference_elevations_calculation.m)
%%%
%%% OUTPUTS:
