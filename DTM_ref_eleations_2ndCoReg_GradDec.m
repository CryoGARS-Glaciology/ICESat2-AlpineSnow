%%% Code for gradient decent after course grid search corregistration
 %%% SPECIFIED INPUTS:
...
filename_sufix = 'A6-40-ref-elevations-grid-search-GD-agg';
...
[~,E] = reference_elevations(zmod, norths, easts, end_flag, default_length, elevations, slope, aspect, Ref, Agrid_best); %calculate ref elevations with the shift
