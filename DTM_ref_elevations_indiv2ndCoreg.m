...
%%% a .9 by .9 m grid search for each individual ICESat-2 overpass. This
%%% code should be performed after DTM_ref_elevations_indivCoreg.m is run
%%%
...
%% Set output name
filename_sufix = 'A6-40-ref-elevations-grid-search-fineGS-ByTrack';
